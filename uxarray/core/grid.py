...
class Grid:
    ...
    def _build_antimeridian_faces(self, bias="left"):
        ...
        # for face_idx, x, e_rhs, e_lhs in zip(antimeridian_face_indices,
        #                                      face_x,
        #                                      edge_length_flags_rhs,
        #                                      edge_length_flags_lhs):
        #
        #
        #
        #     for cur_e_idx, (cur_e_rhs, cur_e_lhs) in enumerate(zip(e_rhs, e_lhs)):
        #
        #         if cur_e_rhs:
        #             pass
        #
        ...
        #
        #
        # # Case 1: Mismatched 0.0 and 360.00
        #
        # pass
