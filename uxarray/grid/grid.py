...
class Grid:
    ...
    @classmethod
    def from_dataset(cls, dataset: xr.Dataset, use_dual: Optional[bool] = False):
    ...
    def antimeridian_face_indices(self) -> np.ndarray:
        ...
        if self._antimeridian_face_indices is None:
            self._antimeridian_face_indices = _build_antimeridian_face_indices(self)
    ...
    def to_shapely_polygons(self, correct_antimeridian_polygons: Optional[bool] = True):
