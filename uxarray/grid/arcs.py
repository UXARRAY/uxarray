...
#
#     pt_lon, pt_lat = _xyz_to_lonlat_rad(pt[0], pt[1], pt[2])
#
#     GCRv0_lon, GCRv0_lat = _xyz_to_lonlat_rad(
#         gca_cart[0][0], gca_cart[0][1], gca_cart[0][2]
#     )
#     GCRv1_lon, GCRv1_lat = _xyz_to_lonlat_rad(
#         gca_cart[1][0], gca_cart[1][1], gca_cart[1][2]
#     )
#
