...
def point_within_gca(pt, gca_cart, is_directed=False):
    ...
    pt_lonlat = _xyz_to_lonlat_rad(pt[0], pt[1], pt[2], scalar=True)
    GCRv0_lonlat = _xyz_to_lonlat_rad(
        gca_cart[0][0], gca_cart[0][1], gca_cart[0][2], scalar=True
    )
    GCRv1_lonlat = _xyz_to_lonlat_rad(
        gca_cart[1][0], gca_cart[1][1], gca_cart[1][2], scalar=True
    )
