...
def _get_spherical_face_edge_nodes(
    ...
    # ^ INT_FILL_VALUE should prob not be used above

    # Fill the array with the Cartesian coordinates of the edges
    face_edges_cartesian[valid_mask, 0] = node_lon[valid_edges]
    face_edges_cartesian[valid_mask, 1] = node_lat[valid_edges]

    return face_edges_cartesian.reshape(n_face, n_max_face_edges, 2, 2)
