...
from uxarray.remap.apply_func import _apply_func_remap_uxds
...
class UxDatasetRemapAccessor:
    ...
    def apply_func(
        ...
        return _apply_func_remap_uxds(
            self.uxds, destination_grid, remap_to, coord_type, func, r
        )
