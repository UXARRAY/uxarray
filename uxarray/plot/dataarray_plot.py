...
def _point_raster(
    ...
    **kwargs,
    ...
    if backend == "matplotlib":
        ...
        ).opts(colorbar=colorbar, cmap=cmap, **kwargs)
    elif backend == "bokeh":
        ...
        raster = hds_rasterize(
            ...
            aggregator=aggregator,
            interpolation=interpolation,
        ).opts(width=width, height=height, colorbar=colorbar, cmap=cmap, **kwargs)
...
def rasterize(
    ...
    **kwargs,
    ...
    if method == "point":
        ...
        raise ValueError("Polygon Rasterization not yet implemented.")
    elif method == "trimesh":
        raise ValueError("Trimesh Rasterization not yet implemented.")
    else:
