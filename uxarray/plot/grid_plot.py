...
def _plot_coords_as_points(
    ...
    **kwargs,
    ...
    if element == "node":
        hv_points = hv.Points(np.array([uxgrid.node_lon, uxgrid.node_lat.values]).T)
    elif element == "face":
        hv_points = hv.Points(np.array([uxgrid.face_lon, uxgrid.face_lat.values]).T)
    elif element == "edge":
        hv_points = hv.Points(np.array([uxgrid.edge_lon, uxgrid.edge_lat.values]).T)
    else:
