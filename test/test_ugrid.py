...
class TestUgrid(TestCase):
    ...
    def test_read_ugrid(self):
        ...
        ux_grid1_node_x_var = ux_grid1.Mesh2_node_x
        ux_grid2_node_x_var = ux_grid2.Mesh2_node_x
        ux_grid3_node_x_var = ux_grid3.Mesh2_node_x

        assert (ux_grid1_node_x_var.size == constants.NNODES_outCSne30)
        assert (ux_grid2_node_x_var.size == constants.NNODES_outRLL1deg)
        assert (ux_grid3_node_x_var.size == constants.NNODES_ov_RLL10deg_CSne4)
