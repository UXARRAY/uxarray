...
def test_uxdataset_astype_returns_uxdataset():
    """Ensures UxDataset.astype() result type is UxDataset.
    Regression test for issue #1737 (though that issue just mentions UxDataArray).
    """
