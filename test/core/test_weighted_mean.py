...
csne30_grid_path = current_path.parent / 'meshfiles' / "ugrid" / "outCSne30" / "outCSne30.ug"
csne30_data_path = current_path.parent / 'meshfiles' / "ugrid" / "outCSne30" / "outCSne30_vortex.nc"

quad_hex_grid_path = current_path.parent / 'meshfiles' / "ugrid" / "quad-hexagon" / "grid.nc"
quad_hex_data_path_face_centered = current_path.parent / 'meshfiles' / "ugrid" / "quad-hexagon" / "data.nc"
quad_hex_data_path_edge_centered = current_path.parent / 'meshfiles' / "ugrid" / "quad-hexagon" / "random-edge-data.nc"
