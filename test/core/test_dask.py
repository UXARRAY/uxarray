...
quad_hex_data_path = current_path.parent / 'meshfiles' / "ugrid" / "quad-hexagon" / 'multi_dim_data.nc'

mpas_grid = current_path.parent / 'meshfiles' / "mpas" / "QU" / 'oQU480.231010.nc'
csne30_grid = current_path.parent / 'meshfiles' / "ugrid" / "outCSne30" / 'outCSne30.ug'
csne30_data = current_path.parent / 'meshfiles' / "ugrid" / "outCSne30" / 'outCSne30_var2.nc'
