...
class TestConnectivity(TestCase):
    ...
    def test_build_face_edges_connectivity_mpas(self):
        ...
        edge_nodes_output, _, _ = _build_edge_node_connectivity(
            mpas_grid_ux.face_node_connectivity.values,
            mpas_grid_ux.n_face,
