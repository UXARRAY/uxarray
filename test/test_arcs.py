...
class TestIntersectionPoint(TestCase):
    def test_pt_within_gcr(self):
        ...
        pt_same_lon_out_2 = ux.grid.coordinates.node_lonlat_rad_to_xyz([0.1, 1.0])
    ...
    def test_pt_within_gcr_antimeridian(self):
        ...
        self.assertTrue(point_within_gca(pt_cart, gcr_cart_flip, is_directed=False))
        ...
        self.assertFalse(point_within_gca(pt_cart_within, gcr_cart_1, is_directed=True))
        self.assertFalse(
        ...
        self.assertTrue(point_within_gca(pt_cart, gcr_car_flipped, is_directed=True))
