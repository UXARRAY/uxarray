...
quad_hex_data_path = current_path.parent / 'meshfiles' / "ugrid" / "quad-hexagon" / 'data.nc'
quad_hex_node_data = current_path.parent / 'meshfiles' / "ugrid" / "quad-hexagon" / 'random-node-data.nc'
