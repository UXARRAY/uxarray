...
class TestGeometryConversions(TestCase):
    ...
    def test_to_polycollection(self):
        ...
        polygon_shells = _build_polygon_shells(
            ...
            uxds_geoflow.uxgrid.n_face,
            uxds_geoflow.uxgrid.n_max_face_nodes,
        ...
        polygon_shells = _build_polygon_shells(
            uxds_ne30.uxgrid.node_lon.values,
            uxds_ne30.uxgrid.node_lat.values,
            uxds_ne30.uxgrid.face_node_connectivity.values,
            uxds_ne30.uxgrid.n_face,
            uxds_ne30.uxgrid.n_max_face_nodes,
