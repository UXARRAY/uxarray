...
gridfile_scrip_CSne8 = current_path.parent / 'meshfiles' / "scrip" / "outCSne8" / 'outCSne8.nc'
gridfile_geoflowsmall_grid = current_path.parent / 'meshfiles' / "ugrid" / "geoflow-small" / 'grid.nc'
gridfile_geoflowsmall_var = current_path.parent / 'meshfiles' / "ugrid" / "geoflow-small" / 'v1.nc'
