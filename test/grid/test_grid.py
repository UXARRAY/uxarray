...
from ..core.test_gradient import quad_hex_grid_path
...
gridfile_geos = current_path.parent / 'meshfiles' / "geos-cs" / "c12" / 'test-c12.native.nc4'
gridfile_mpas_holes = current_path.parent / 'meshfiles' / "mpas" / "QU" / 'oQU480.231010.nc'
...
gridfile_mpas_two = current_path.parent / 'meshfiles' / "mpas" / "QU" / 'oQU480.231010.nc'
